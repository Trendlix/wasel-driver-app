          ...
          return Padding(
            ...
            child: BlocListener<ProfileCubit, ProfileStates>(
              listener: (context, state) {
                if (state.renewDriverDocumentStatus == RequestStatus.success) {
                  Navigator.pop(context);
                  showSuccess(context, 'Document renewed successfully');
                } else if (state.renewDriverDocumentStatus == RequestStatus.error) {
                  showError(
                    context,
                    state.renewDriverDocumentErrorMessage ?? 'Failed to renew document',
                  );
                }
              },
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (selectedExpiryDate == null || selectedFile == null) {
                          ...
                          context.read<ProfileCubit>().renewDriverDocument(
                        ...
                        child: BlocBuilder<ProfileCubit, ProfileStates>(
                          builder: (context, state) {
                            if (state.renewDriverDocumentStatus == RequestStatus.loading) {
